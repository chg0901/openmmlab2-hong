...
# load_from = 'mmdetection/work_dirs/rtmdet_tiny_Ear/epoch_20.pth'
# # 训练超参数 2nd round 
# MAX_EPOCHS = 50
# TRAIN_BATCH_SIZE = 16
# VAL_BATCH_SIZE = 16
...
# load_from = 'mmdetection/work_dirs/rtmdet_tiny_Ear/epoch_50.pth'

# 训练超参数 3rd round 
MAX_EPOCHS = 200
TRAIN_BATCH_SIZE = 28  # 32 out-of-memory
VAL_BATCH_SIZE = 16
stage2_num_epochs = 20
base_lr = 0.004
VAL_INTERVAL = 5 # 每隔多少轮评估保存一次模型权重
